...
const messages = {
  en: {
    ...
    users: {
      ...
      emailOrGithubExists: 'A user with this GitHub username already exists',
      ...
      searchPlaceholder: 'Search name or GitHub username...',
      user: 'User',
  ...
  fr: {
    ...
    users: {
      ...
      emailOrGithubExists: 'Un utilisateur avec ce nom GitHub existe déjà',
      ...
      searchPlaceholder: 'Rechercher par nom ou nom GitHub...',
      user: 'Utilisateur',
